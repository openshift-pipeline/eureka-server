#FROM image-registry.openshift-image-registry.svc:5000/openshift/openjdk
#VOLUME /测试 eureka
#ADD cloud-demo-eureka-server.jar eureka-server.jar
#EXPOSE 8761
...
COPY configuration/settings.xml /etc/maven/settings.xml
